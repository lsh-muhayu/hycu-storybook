import{j as e,H as x,r as j}from"./iframe-mkfPu5JP.js";import{D as n,S as l}from"./Select-COATX4Lc.js";import{B as h}from"./Button-pJMiEcIy.js";import{L as t}from"./Label-8yYXwoX4.js";import{I as u}from"./Input-Dgi_HnVt.js";import{T as C}from"./Textarea-CBv7zeGm.js";import{C as D}from"./Checkbox-BU4N3EMO.js";import"./preload-helper-PPVm8Dsz.js";import"./ScrollArea-BxEtyMDU.js";import"./index-BaBjddpJ.js";import"./index-DVeWkFTi.js";import"./index-BWh_98kt.js";import"./index-BD21Y2cd.js";import"./index-DQ6AaM_l.js";import"./index-Dut8MDga.js";const P={title:"Shared/UI/Dialog",parameters:{layout:"centered",docs:{description:{component:`
### 다이얼로그 컴포넌트
...
이 예시에서는 \`className="w-[400px]"\`를 사용하여 Content의 너비를 400px로 제한하고, 넓은 테이블을 포함하여 가로 스크롤이 발생하도록 했습니다.
        `}}},render:()=>{const a=()=>{x.open(o=>e.jsx(n,{overlayControl:o,children:e.jsxs(n.Content,{className:"h-[400px] w-[400px]",children:[e.jsxs(n.Header,{children:[e.jsx(n.Title,{children:"가로/세로 스크롤이 있는 다이얼로그"}),e.jsx(n.Description,{children:"이 다이얼로그는 Body 영역에 가로 스크롤이 생길 만큼 넓은 콘텐츠를 포함합니다."})]}),e.jsx(n.Body,{children:e.jsx("div",{className:"min-w-[800px]",children:e.jsxs("table",{className:"w-full border-collapse border border-gray-300",children:[e.jsx("thead",{children:e.jsxs("tr",{className:"bg-gray-100",children:[e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"이름"}),e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"이메일 주소"}),e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"전화번호"}),e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"소속 부서"}),e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"직책"}),e.jsx("th",{className:"border border-gray-300 p-2 text-left",children:"상태"})]})}),e.jsx("tbody",{children:Array.from({length:10}).map((s,r)=>e.jsxs("tr",{children:[e.jsxs("td",{className:"border border-gray-300 p-2",children:["홍길동",r+1]}),e.jsxs("td",{className:"border border-gray-300 p-2",children:["hong.gildong",r+1,"@example.com"]}),e.jsxs("td",{className:"border border-gray-300 p-2",children:["010-1234-567",r]}),e.jsx("td",{className:"border border-gray-300 p-2",children:"컴퓨터공학과"}),e.jsx("td",{className:"border border-gray-300 p-2",children:"교수"}),e.jsx("td",{className:"border border-gray-300 p-2",children:"활성"})]},r))})]})})}),e.jsxs(n.Footer,{children:[e.jsx(n.CancelButton,{children:"취소"}),e.jsx(n.Close,{children:e.jsx(n.ConfirmButton,{children:"확인"})})]})]})}))};return e.jsx(h,{onClick:a,children:"가로 스크롤 다이얼로그 열기"})}},p={render:()=>e.jsxs(n.PrimitiveRoot,{children:[e.jsx(n.Trigger,{children:"주차별 논문지도 계획 추가"}),e.jsxs(n.Content,{className:"h-[750px] w-[500px]",children:[e.jsx(n.Header,{children:e.jsx(n.Title,{children:"주차별 논문지도 계획 추가"})}),e.jsx(n.Body,{children:e.jsxs("section",{className:"space-y-4",children:[e.jsxs("section",{className:"flex gap-4",children:[e.jsxs("div",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"주차"}),e.jsx(u,{type:"number"})]}),e.jsxs("div",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"계획일"}),e.jsx(u,{type:"date"})]})]}),e.jsxs("section",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"담당교수 선택"}),e.jsxs("div",{className:"space-y-2.5",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(D,{id:"advisor-kim",className:"peer"}),e.jsx(t,{htmlFor:"advisor-kim",className:"peer-data-[state=checked]:text-primary cursor-pointer text-sm font-medium text-gray-700",children:"김교수 (주지도교수)"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(D,{id:"advisor-hong",className:"peer"}),e.jsx(t,{htmlFor:"advisor-hong",className:"peer-data-[state=checked]:text-primary cursor-pointer text-sm font-medium text-gray-700",children:"홍교수 (부지도교수)"})]})]})]}),e.jsxs("section",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"지도 주제"}),e.jsx(u,{type:"text",placeholder:"예: 연구방법론 개요"})]}),e.jsxs("section",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"계획 내용"}),e.jsx(C,{className:"h-24",placeholder:"지도할 내용을 상세히 입력하세요"})]}),e.jsxs("section",{className:"flex w-full flex-col gap-2",children:[e.jsx(t,{required:!0,children:"지도 방식"}),e.jsxs(l,{children:[e.jsx(l.Trigger,{placeholder:"선택하세요"}),e.jsxs(l.Content,{children:[e.jsx(l.Item,{value:"대면",children:"대면"}),e.jsx(l.Item,{value:"온라인",children:"온라인"}),e.jsx(l.Item,{value:"Zoom",children:"Zoom"}),e.jsx(l.Item,{value:"이메일",children:"이메일"}),e.jsx(l.Item,{value:"전화",children:"전화"})]})]})]}),e.jsxs("div",{className:"flex items-start gap-2 rounded-md bg-blue-50 p-3",children:[e.jsx("span",{className:"text-base",children:"💡"}),e.jsx("p",{className:"text-sm text-gray-700",children:"계획을 저장한 후, 실제 지도를 진행하면 '실적입력' 버튼을 클릭하여 실행 내용을 기록하세요."})]})]})}),e.jsxs(n.Footer,{children:[e.jsx(n.CancelButton,{className:"w-full",children:"취소"}),e.jsx(n.Close,{children:e.jsx(n.ConfirmButton,{className:"w-full",children:"저장"})})]})]})]})};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: args => {
  ...
  render: () => {
    const LoadingDialog = ({
      ...
      return <Dialog overlayControl={control} loading={loading} dismissMode="dismiss">
          <Dialog.Content>
            <Dialog.Header>
    ...
    return <Button onClick={() => overlay.open(overlayControl => <LoadingDialog control={overlayControl} />)}>
        로딩 다이얼로그 열기
      </Button>;
  }
...
}`,...p.parameters?.docs?.source}}};const R=["Default","WithOverlayKit","WithLoading","WithLongContent","WithHorizontalScroll","ThesisGuidancePlanForm"];export{i as Default,p as ThesisGuidancePlanForm,m as WithHorizontalScroll,d as WithLoading,g as WithLongContent,c as WithOverlayKit,R as __namedExportsOrder,P as default};
