...
}`,...L.parameters?.docs?.source}}};const lt=["기본툴팁","위치별툴팁","지연시간설정","다양한스타일","컴포넌트포함","다이얼로그내부"];export{lt as __namedExportsOrder,ot as default,_ as 기본툴팁,S as 다양한스타일,L as 다이얼로그내부,O as 위치별툴팁,A as 지연시간설정,z as 컴포넌트포함};
