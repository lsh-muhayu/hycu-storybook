import{r as p,j as e,a as se,R as O,H as z}from"./iframe-Ct6cBN0f.js";import{c as re,P as F,u as M,d as H,a as j,e as te}from"./index-w90ALqq8.js";import{c as W,R as ae,A as L,P as le,h as ie,a as ce,u as de,F as pe,b as me,C as xe,d as ge,e as he,D as d}from"./index-Z6jdyO17.js";import{u as ve}from"./index-CMO2IfL1.js";import{u as ue}from"./index-BnUxCBFQ.js";import{B as a}from"./Button-BzLycsm1.js";import{S as x}from"./Select-BoRfe5Ux.js";import{C as I}from"./Checkbox-BwzN8RnV.js";import{I as U}from"./info-CdgyHOey.js";import{S as $}from"./settings-h3jq42xj.js";import{U as fe}from"./user-C7BhQcjD.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Ckh8wc6S.js";import"./index-Dr9knix5.js";import"./ScrollArea--6jhWGxl.js";import"./index-cTMbTQbW.js";import"./index-DJ4grFFS.js";import"./index-RvRXAbJj.js";import"./index-_P_ERcTV.js";import"./check-BVy4-bTP.js";var E="Popover",[G]=re(E,[W]),P=W(),[je,g]=G(E),K=n=>{const{__scopePopover:t,children:r,open:s,defaultOpen:l,onOpenChange:i,modal:c=!1}=n,m=P(t),h=p.useRef(null),[v,N]=p.useState(!1),[C,u]=ue({prop:s,defaultProp:l??!1,onChange:i,caller:E});return e.jsx(ae,{...m,children:e.jsx(je,{scope:t,contentId:ve(),triggerRef:h,open:C,onOpenChange:u,onOpenToggle:p.useCallback(()=>u(k=>!k),[u]),hasCustomAnchor:v,onCustomAnchorAdd:p.useCallback(()=>N(!0),[]),onCustomAnchorRemove:p.useCallback(()=>N(!1),[]),modal:c,children:r})})};K.displayName=E;var V="PopoverAnchor",Z=p.forwardRef((n,t)=>{const{__scopePopover:r,...s}=n,l=g(V,r),i=P(r),{onCustomAnchorAdd:c,onCustomAnchorRemove:m}=l;return p.useEffect(()=>(c(),()=>m()),[c,m]),e.jsx(L,{...i,...s,ref:t})});Z.displayName=V;var q="PopoverTrigger",J=p.forwardRef((n,t)=>{const{__scopePopover:r,...s}=n,l=g(q,r),i=P(r),c=M(t,l.triggerRef),m=e.jsx(H.button,{type:"button","aria-haspopup":"dialog","aria-expanded":l.open,"aria-controls":l.contentId,"data-state":oe(l.open),...s,ref:c,onClick:j(n.onClick,l.onOpenToggle)});return l.hasCustomAnchor?m:e.jsx(L,{asChild:!0,...i,children:m})});J.displayName=q;var _="PopoverPortal",[Pe,Ne]=G(_,{forceMount:void 0}),Q=n=>{const{__scopePopover:t,forceMount:r,children:s,container:l}=n,i=g(_,t);return e.jsx(Pe,{scope:t,forceMount:r,children:e.jsx(F,{present:r||i.open,children:e.jsx(le,{asChild:!0,container:l,children:s})})})};Q.displayName=_;var f="PopoverContent",X=p.forwardRef((n,t)=>{const r=Ne(f,n.__scopePopover),{forceMount:s=r.forceMount,...l}=n,i=g(f,n.__scopePopover);return e.jsx(F,{present:s||i.open,children:i.modal?e.jsx(ye,{...l,ref:t}):e.jsx(Be,{...l,ref:t})})});X.displayName=f;var Ce=te("PopoverContent.RemoveScroll"),ye=p.forwardRef((n,t)=>{const r=g(f,n.__scopePopover),s=p.useRef(null),l=M(t,s),i=p.useRef(!1);return p.useEffect(()=>{const c=s.current;if(c)return ie(c)},[]),e.jsx(ce,{as:Ce,allowPinchZoom:!0,children:e.jsx(Y,{...n,ref:l,trapFocus:r.open,disableOutsidePointerEvents:!0,onCloseAutoFocus:j(n.onCloseAutoFocus,c=>{c.preventDefault(),i.current||r.triggerRef.current?.focus()}),onPointerDownOutside:j(n.onPointerDownOutside,c=>{const m=c.detail.originalEvent,h=m.button===0&&m.ctrlKey===!0,v=m.button===2||h;i.current=v},{checkForDefaultPrevented:!1}),onFocusOutside:j(n.onFocusOutside,c=>c.preventDefault(),{checkForDefaultPrevented:!1})})})}),Be=p.forwardRef((n,t)=>{const r=g(f,n.__scopePopover),s=p.useRef(!1),l=p.useRef(!1);return e.jsx(Y,{...n,ref:t,trapFocus:!1,disableOutsidePointerEvents:!1,onCloseAutoFocus:i=>{n.onCloseAutoFocus?.(i),i.defaultPrevented||(s.current||r.triggerRef.current?.focus(),i.preventDefault()),s.current=!1,l.current=!1},onInteractOutside:i=>{n.onInteractOutside?.(i),i.defaultPrevented||(s.current=!0,i.detail.originalEvent.type==="pointerdown"&&(l.current=!0));const c=i.target;r.triggerRef.current?.contains(c)&&i.preventDefault(),i.detail.originalEvent.type==="focusin"&&l.current&&i.preventDefault()}})}),Y=p.forwardRef((n,t)=>{const{__scopePopover:r,trapFocus:s,onOpenAutoFocus:l,onCloseAutoFocus:i,disableOutsidePointerEvents:c,onEscapeKeyDown:m,onPointerDownOutside:h,onFocusOutside:v,onInteractOutside:N,...C}=n,u=g(f,r),k=P(r);return de(),e.jsx(pe,{asChild:!0,loop:!0,trapped:s,onMountAutoFocus:l,onUnmountAutoFocus:i,children:e.jsx(me,{asChild:!0,disableOutsidePointerEvents:c,onInteractOutside:N,onEscapeKeyDown:m,onPointerDownOutside:h,onFocusOutside:v,onDismiss:()=>u.onOpenChange(!1),children:e.jsx(xe,{"data-state":oe(u.open),role:"dialog",id:u.contentId,...k,...C,ref:t,style:{...C.style,"--radix-popover-content-transform-origin":"var(--radix-popper-transform-origin)","--radix-popover-content-available-width":"var(--radix-popper-available-width)","--radix-popover-content-available-height":"var(--radix-popper-available-height)","--radix-popover-trigger-width":"var(--radix-popper-anchor-width)","--radix-popover-trigger-height":"var(--radix-popper-anchor-height)"}})})})}),ee="PopoverClose",be=p.forwardRef((n,t)=>{const{__scopePopover:r,...s}=n,l=g(ee,r);return e.jsx(H.button,{type:"button",...s,ref:t,onClick:j(n.onClick,()=>l.onOpenChange(!1))})});be.displayName=ee;var De="PopoverArrow",Te=p.forwardRef((n,t)=>{const{__scopePopover:r,...s}=n,l=P(r);return e.jsx(ge,{...l,...s,ref:t})});Te.displayName=De;function oe(n){return n?"open":"closed"}var Ae=K,we=Z,Se=J,Re=Q,Oe=X;const ne=n=>e.jsx(Ae,{...n}),Ee=n=>e.jsx(Se,{...n}),ke=n=>{const{className:t,align:r="center",sideOffset:s=4,container:l,collisionBoundary:i=[],...c}=n,{collisionBoundary:m,container:h,collisionPadding:v}=he({collisionBoundary:i,container:l});return e.jsx(Re,{container:h,children:e.jsx(Oe,{className:se("w-full min-w-72 p-4","origin-(--radix-popover-content-transform-origin) rounded-md border border-gray-50 bg-white shadow-md outline-none","data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=bottom]:slide-in-from-top-2 data-[side=top]:slide-in-from-bottom-2",t),align:r,sideOffset:s,collisionBoundary:m,collisionPadding:v,...c})})},Ie=n=>e.jsx(we,{...n}),o=Object.assign(ne,{Trigger:Ee,Content:ke,Anchor:Ie});ne.__docgenInfo={description:"",methods:[],displayName:"PopoverRoot"};const no={title:"Shared/UI/Popover",component:o,parameters:{layout:"centered",docs:{description:{component:`
### 팝오버 컴포넌트
...
}`,...R.parameters?.docs?.source}}};const so=["Basic","WithRichContent","Positions","WithAnchor","InDialog","InDialogWithLongContent","Controlled","WithForm","MultiplePopovers"];export{y as Basic,w as Controlled,T as InDialog,A as InDialogWithLongContent,R as MultiplePopovers,b as Positions,D as WithAnchor,S as WithForm,B as WithRichContent,so as __namedExportsOrder,no as default};
