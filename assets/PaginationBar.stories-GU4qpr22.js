import{j as e,r as p}from"./iframe-Ct6cBN0f.js";import{P as s}from"./Pagination-eRfGJ3Bm.js";import"./preload-helper-PPVm8Dsz.js";import"./Button-BzLycsm1.js";import"./chevron-right-PVOCQ-8d.js";const i=c=>{const{currentPage:a,onPageChange:n,totalPages:P}=c,r=Math.max(P,1),t=Math.floor((a-1)/10)*10+1,u=Math.min(t+9,r);return e.jsxs(s,{children:[e.jsx(s.First,{disabled:a===1,onClick:()=>n(1)}),e.jsx(s.Previous,{disabled:a===1,onClick:()=>n(Math.max(t-1,1))}),Array.from({length:u-t+1}).map((m,o)=>e.jsx(s.Item,{isCurrent:a===o+t,onClick:()=>n(o+t),children:o+t},o)),e.jsx(s.Next,{disabled:a===r,onClick:()=>n(Math.min(u+1,r))}),e.jsx(s.Last,{disabled:a===r,onClick:()=>n(r)})]})};i.__docgenInfo={description:"",methods:[],displayName:"PaginationBar",props:{currentPage:{required:!0,tsType:{name:"number"},description:"현재 페이지 번호"},onPageChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(page: number) => void",signature:{arguments:[{type:{name:"number"},name:"page"}],return:{name:"void"}}},description:"페이지 변경 시 실행 핸들러"},totalPages:{required:!0,tsType:{name:"number"},description:"총 페이지 수"}}};const y={title:"Shared/UI/PaginationBar",parameters:{layout:"centered",docs:{description:{component:`
### 페이지네이션 바 컴포넌트
...
}`,...g.parameters?.docs?.source}}};const b=["Examples"];export{g as Examples,b as __namedExportsOrder,y as default};
